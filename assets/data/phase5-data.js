/* Phase 5: Summit Push — generated from content/phase5.md by content/tools/build.js. */
/* Edit content/phase5.md, then run: node content/tools/build.js */
/* IBM Docs reference: https://www.ibm.com/docs/en/maas360 */
window.PHASE5_DATA = {
  "id": "phase5",
  "title": "Phase 5: Summit Push",
  ...
  "tasks": [
    {
      ...
      "learn": [
        {
          ...
          "body": "<p>MaaS360 Web Services (APIs) let other systems pull device data, push actions, and automate workflows — for example syncing device status into ServiceNow or triggering a remote wipe from a script.</p>"
        },
        {
          "id": "p2",
          "title": "What APIs unlock",
          "body": "<p>APIs turn MaaS360 into something other tools can talk to. Instead of an admin clicking in the console, a system can ask MaaS360 for device data or tell it to act — enabling integrations and automation at scale.</p>"
        },
        {
          "id": "p3",
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "MaaS360 APIs are mainly used to…",
            "options": [
              "Charge devices",
              "Integrate and automate with other systems",
              "Design logos",
          ...
          {
            "type": "mc",
            "question": "An example integration target mentioned for APIs is…",
            "options": [
              "ServiceNow",
              "Photoshop",
              "Excel macros",
          ...
          {
            "type": "mc",
            "question": "APIs let an external system…",
            "options": [
              "Pull device data and trigger actions",
          ...
          {
            "type": "mc",
            "question": "Automation via API reduces…",
            "options": [
          ...
          {
            "type": "mc",
            "question": "A remote action you might trigger via API is…",
            "options": [
              "A device wipe or lock",
              "A firmware redesign",
              "A new SIM contract",
              "A hardware swap"
            ],
          ...
          {
            "type": "text",
            "question": "Give one workflow at a customer that would be faster if it were automated through the MaaS360 API."
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "A customer's IT team wants device status to appear automatically in ServiceNow. Sketch, in plain terms, how the MaaS360 API makes that possible."
      }
    },
    {
      "id": "task-pipeline-renewal-awareness",
      "phaseId": "phase5",
      "title": "Pipeline/Renewal Awareness",
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "A BTS engineer scans the pipeline for…",
            "options": [
              "Deals where technical work — demo, POC, fix — changes the outcome",
          ...
          {
            "type": "mc",
            "question": "A renewal at risk often traces to…",
            "options": [
              "Unfinished adoption or unresolved technical friction",
              "The logo",
              "Calendar season",
          ...
          {
            "type": "mc",
            "question": "The pre-renewal technical touch means…",
            "options": [
              "Reviewing environment health and fixing friction before the commercial conversation",
          ...
          {
            "type": "text",
            "question": "For one real deal at technical evaluation: what's the deal, what's blocking it, and what technical action would you propose this week?"
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Bring your two-deal analysis to the AE(s) who own them and ask whether your proposed technical actions make sense. Where they say yes — offer to do it. That's the moment pipeline awareness becomes pipeline contribution."
      }
    },
    {
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "RFP technical answers must be accurate because…",
            "options": [
              "They become contractual expectations after the win",
              "Nobody reads them",
              "Style matters more",
              "They're disposable"
            ],
          ...
          {
            "type": "mc",
            "question": "A requirement the product doesn't fully meet deserves…",
            "options": [
              "An honest \"partially\" or \"no, with approach\" — trust-building and defensible",
              "A creative \"yes\"",
              "Silence",
              "Deleting the row"
            ],
          ...
          {
            "type": "mc",
            "question": "Reusing past answers requires…",
            "options": [
              "Verifying they're still current — features move",
          ...
          {
            "type": "mc",
            "question": "An ambiguous requirement gets…",
            "options": [
              "A logged clarifying question, not a guess",
              "Your best guess",
              "A yes to be safe",
              "Skipped"
            ],
          ...
          {
            "type": "text",
            "question": "Draft the answer to: \"Describe how the solution prevents corporate data access from non-compliant devices.\" Three sentences, house-style."
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Ask your mentor for a live or recent RFP and take three real rows end to end: draft, review, final. Track what the reviewer changed — the delta between your draft and the shipped answer is the house style, learned fastest by diff."
      }
    },
    {
      "id": "task-pre-checks",
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "The pre-check ritual is run…",
            "options": [
              "Identically before every customer session, regardless of confidence",
          ...
          {
            "type": "mc",
            "question": "Backup screenshots of fragile features exist because…",
            "options": [
              "A live failure then costs a sentence, not the demo",
          ...
          {
            "type": "mc",
            "question": "The context layer prevents…",
            "options": [
              "Repeating or contradicting what the customer already discussed with the team",
              "Technical failures",
              "Long meetings",
              "Nothing"
            ],
          ...
          {
            "type": "text",
            "question": "What are your two personal-experience additions to the list, and what incident motivated each?"
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Laminate it (literally or digitally): make your pre-check list a fixed artifact, and run it before every mock and real session from now on. In your Phase 6 live sessions, note each time an item catches something — that log is the ritual proving its worth."
      }
    },
    {
      "id": "task-weekly-call",
      ...
      "learn": [
        {
          "id": "p1",
          "title": "What the weekly call is for",
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "A good deal update contains…",
            "options": [
              "Where it stands, what changed, what's next / the ask — in about twenty seconds",
              "The full history",
              "Only good news",
          ...
          {
            "type": "mc",
            "question": "Blockers are raised…",
            "options": [
              "Plainly and with a specific ask",
          ...
          {
            "type": "mc",
            "question": "The war story belongs…",
            "options": [
              "After the call — where it still should be told",
              "In the update",
              "Nowhere",
              "In email only"
            ],
          ...
          {
            "type": "text",
            "question": "Write your next weekly update in the three-part shape, exactly as you'd say it."
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Contribute updates for three consecutive weeks. After the third, ask your manager for one piece of feedback on your updates — sharpening this small skill compounds: it's how the whole team perceives your work."
      }
    },
    {
      ...
      "learn": [
        {
          "id": "p1",
          "title": "Pressure-testing the demo",
          "body": "<p>Your Phase 4 demo ran in calm waters. Real customers interrupt, challenge, and derail: \"how much does this cost?\", \"our current tool does that too,\" \"can we skip to the Windows part?\", plus the classic mid-demo technical failure. This role play adds those stressors deliberately, with a teammate briefed to push — because composure is trainable, but only under pressure.</p>"
        },
        {
          "id": "p2",
          "title": "The handling repertoire",
          "body": "<p><b>Park</b>: \"great question — pricing is [AE]'s domain; let me make sure it's covered after\" (note it visibly). <b>Bridge</b>: \"it does — and the difference worth showing is…\" (acknowledge, don't argue). <b>Flex</b>: \"let's jump to Windows now\" (a demo is a conversation, not a script — but close the loop on what you skipped). <b>Recover</b>: narrate honestly, use the backup, move on. After each handled moment, return to your spine — the skill is bending without losing the story.</p>"
        }
      ],
      "practice": {
        "iframePlaceholder": true,
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "A pricing question mid-demo gets…",
            "options": [
              "Parked visibly for the AE, with the demo resuming",
              "A price quote",
              "Ignored",
              "The demo ended"
            ],
          ...
          {
            "type": "mc",
            "question": "\"Our current tool does that too\" gets…",
            "options": [
              "Acknowledged, then bridged to a differentiating depth — never argued",
              "\"No it doesn't\"",
              "A feature war",
          ...
          {
            "type": "mc",
            "question": "A request to skip ahead means…",
            "options": [
              "Flex to it — the demo serves the customer — then close the loop on skipped ground",
          ...
          {
            "type": "mc",
            "question": "Composure under interruption is built by…",
            "options": [
          ...
          {
            "type": "text",
            "question": "Which interruption rattled you most, and what's your exact recovery line for it now?"
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Run the pressure demo twice with escalating difficulty (second run: your mentor plays a genuinely tough technical evaluator). Passing bar: the observer would let you in front of a real skeptical customer. Their word for it is the gate to Phase 6's live sessions."
      }
    },
    {
      "id": "task-practice-device-actions",
      "phaseId": "phase5",
      "title": "Practice Device Actions",
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "A departing employee's BYOD phone gets…",
            "options": [
              "Selective wipe — corporate data and access removed, personal untouched",
              "Full wipe",
              "Nothing",
              "Locate only"
            ],
          ...
          {
            "type": "mc",
            "question": "Full wipe is proportionate for…",
            "options": [
              "Stolen or terminally compromised corporate devices",
              "Every lost device",
              "BYOD offboarding",
              "Slow devices"
            ],
          ...
          {
            "type": "mc",
            "question": "A misplaced (probably-at-home) BYOD phone first gets…",
            "options": [
              "Lock and locate — reversible, proportionate steps",
          ...
          {
            "type": "mc",
            "question": "The stolen-device demo lands because…",
            "options": [
              "It shows control, speed, and the BYOD privacy boundary in one 90-second story",
              "Theft is fun",
              "It uses every menu",
              "It's long"
            ],
          ...
          {
            "type": "text",
            "question": "Narrate your stolen-device sequence, action by action, including the escalation decision and the BYOD boundary sentence."
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Perform the stolen-device drill live for your buddy three times: corporate device, BYOD device, and one where the \"customer\" pressures you to full-wipe a BYOD phone — practice holding the proportionate line and explaining why. This 90 seconds belongs in every demo you'll ever run."
      }
    },
    {
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "A customer with an existing MDM gets…",
            "options": [
              "A sequenced migration story — new devices first, legacy fleet in waves",
          ...
          {
            "type": "mc",
            "question": "The Apple ID is blocked by their security team. The session…",
            "options": [
              "Re-orders to achievable work now; the blocked item becomes a written, owned next step",
              "Is cancelled",
              "Waits on hold",
          ...
          {
            "type": "mc",
            "question": "\"Why do we need ABM?\" is best answered with…",
            "options": [
              "The consequence: without it, every corporate iPhone needs hands-on setup",
              "\"Apple requires it\"",
              "\"Trust me\"",
              "A docs link"
            ],
          ...
          {
            "type": "text",
            "question": "What did the harder persona expose in your runbook, and what's now on your complications page?"
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Finalize the runbook with its complications page and file it with your POC kit and pre-check list. Your Phase 6 onboardings are live — this document is what you'll be holding when the real customer's real security team really hasn't released the Apple ID."
      }
    },
    {
      "id": "task-mock-poc-1",
      ...
      "learn": [
        {
          "id": "p1",
          "title": "The full arc, compressed",
          "body": "<p>This mock runs the whole POC lifecycle from your Phase 4 kit, compressed into about two weeks alongside your other work: a <b>kickoff</b> with your mentor/buddy playing the customer (agree 6–8 written success criteria), a <b>setup day</b> (plumbing health checks against the demo environment), at least two <b>weekly check-ins</b> (progress against criteria, one planted blocker to triage), and a <b>close</b> (walk the criteria, capture results, deliver the technical-win summary).</p>"
        },
        {
          "id": "p2",
          "title": "What's being graded",
          "body": "<p>Not perfection — process. Did criteria exist in writing before configuration? Did check-ins actually track them? Did the planted blocker get triaged with your Phase 4 method and communicated honestly? Did the close produce a document an AE could take into a commercial conversation? These process marks are exactly what your mentor will watch for in the real POCs ahead.</p>"
        }
      ],
      "practice": {
        "iframePlaceholder": true,
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "Configuration begins…",
            "options": [
              "After written criteria are agreed — never before",
          ...
          {
            "type": "mc",
            "question": "The planted blocker exists to test…",
            "options": [
              "Your triage method and honest communication under way",
              "Your patience",
          ...
          {
            "type": "mc",
            "question": "The close document matters because…",
            "options": [
              "It's what the AE carries into the commercial conversation — the technical win, in writing",
              "Paperwork is virtue",
              "It restarts the POC",
              "Nobody reads it"
            ],
          ...
          {
            "type": "text",
            "question": "Paste your mock POC's success criteria list. Which one was hardest to make testable, and how did you fix it?"
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Hold a retro with your mentor against the process marks: criteria discipline, cadence quality, triage under way, close quality. Their sign-off on this mock is the gate to touching real POCs — Mock POC 2 (Phase 6) and 3 (Phase 7) raise the stakes from here."
      }
    },
    {
      "id": "task-lead-demo",
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "Questions past your knowledge edge get…",
            "options": [
              "The clean handoff line to your mentor — never a guess",
              "Your best guess",
          ...
          {
            "type": "mc",
            "question": "The safety-net protocol is agreed…",
            "options": [
              "Before the call, including when the mentor steps in unprompted",
              "During the call",
              "Never — improvise",
              "After the call"
            ],
          ...
          {
            "type": "mc",
            "question": "The debrief happens within 24 hours because…",
            "options": [
              "The detail that teaches most evaporates fastest",
          ...
          {
            "type": "text",
            "question": "From your lead demo: what did the net catch, and what will you own solo next time?"
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Schedule and deliver the demo. In the debrief, agree with your mentor the specific criteria for reducing the net next rep (fewer planned step-ins, you fielding the Q&A alone). Phase 6 makes this motion routine — this rep makes it real."
      }
    },
    {
      ...
      "learn": [
        {
          ...
          "body": "<p>Phase 5 was the summit push: pressure-tested demo, hardened onboarding runbook, a full mock POC with process sign-off, device-action fluency, pipeline contribution, and — the big one — your first customer-facing lead demo with the net. Ready for Phase 6 means those motions repeat without drama: Phase 6 is live demos, live onboardings, and Mock POC 2, all with thinner safety nets.</p>"
        },
        {
          "id": "p2",
          "title": "How the check works",
          "body": "<p>Bring evidence, not claims: the mock POC close document, the revised runbook with complications page, the lead-demo debrief notes, and your weekly-call updates. The manager conversation here is less \"are you ready?\" and more \"what support do you still want in Phase 6?\" — name it honestly; nets exist to be requested.</p>"
        }
      ],
      "practice": {
        "iframePlaceholder": true,
      ...
      "assess": {
        "questions": [
          {
            "type": "mc",
            "question": "Phase 5's evidence pack matters because…",
            "options": [
              "Live-phase readiness is shown by artifacts and reps, not self-assessment",
          ...
          {
            "type": "mc",
            "question": "The \"still want support on\" list is…",
            "options": [
              "Honest and specific — nets exist to be requested",
              "A weakness to hide",
          ...
          {
            "type": "mc",
            "question": "Phase 6 differs from Phase 5 mainly by…",
            "options": [
              "Volume and thinner nets on the same live motions",
              "All-new skills",
          ...
          {
            "type": "text",
            "question": "What's on your support list for Phase 6, and what would make you take each item off it?"
          }
        ]
      },
      "apply": {
        "isRealScenario": false,
        "scenario": "Run the review with the evidence pack. Agree the Phase 6 plan: which live demos and onboardings you'll take, with what support. Then go — the summit is in sight and the remaining phases are made of real customers."
      }
    }
  ]
};
